...
const char*                       __PRECAUTION_SCREEN_TITLE_FONT =              "GUIFont";
...
const char*                       __AUTO_PAUSE_SELECT_SCREEN_TITLE_FONT =       "GUIFont";
...
const char*                       __LANGUAGE_SELECT_SCREEN_TITLE_FONT =         "GUIFont";

// VBJaEngine splash screen
TitleScreenState                (*__VBJAENGINE_SPLASH_SCREEN_NEXT_STATE)() =    TitleScreenState_getInstance;
...
const char*                       __AUTO_PAUSE_SCREEN_TITLE_FONT =              "GUIFont";
