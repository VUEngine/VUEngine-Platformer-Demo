...
StageROMDef LEVEL_0_0_0_ST = {
		...
		{	
			...
			{&PIRANHA_PLANT_V_MC, {165, 181, PLAYABLE_LAYER_0 + 2}, NULL},
			...
			{&FLOOR1_BG, {1448 - 100, LAYER_1_FLOOR, LAYER_1}, NULL},
			{&FLOOR0_BG, {1604, LAYER_1_FLOOR, LAYER_1}, NULL},

			{&PIPE0_BG, {1506 - 158, 186 - 20, LAYER_1 + 1}, NULL},
			{&PIRANHA_PLANT_V_MC, {1505 - 158, 181 - 20, LAYER_1 + 2}, NULL},
