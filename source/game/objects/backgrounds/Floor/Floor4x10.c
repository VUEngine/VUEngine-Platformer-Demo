...
SpriteROMDef* const FLOOR_4x10_BG_SPRITES[] =
{
...
SpriteROMDef AFFINE_FLOOR_4x10_BG_SPRITE =
{
	// sprite's type
	__TYPE(Sprite),
...
SpriteROMDef* const AFFINE_FLOOR_4x10_BG_SPRITES[] =
{
