...
PositionedEntityROMDef LEVEL_SELECTOR_ST_ENTITIES[] = {
	...
	// bottom
	{&FLOOR_48x2x48, 		{SCREEN_X_POSITION + __SCREEN_WIDTH / 2, SCREEN_Y_POSITION + __SCREEN_HEIGHT - 2 * 8, START_LAYER}, NULL}, 
	//left
	{&FLOOR_2x28x48, 		{SCREEN_X_POSITION + 16, SCREEN_Y_POSITION + __SCREEN_HEIGHT / 2, START_LAYER}, NULL}, 
	// right
	{&FLOOR_2x28x48, 		{SCREEN_X_POSITION + __SCREEN_WIDTH - 16, SCREEN_Y_POSITION + __SCREEN_HEIGHT / 2, START_LAYER}, NULL}, 
	// front
	{&FLOOR_48x28x2, 		{SCREEN_X_POSITION + __SCREEN_WIDTH / 2, SCREEN_Y_POSITION + __SCREEN_HEIGHT - 2 * 8, START_LAYER}, NULL}, 
	// back
	{&FLOOR_48x28x2, 		{SCREEN_X_POSITION + __SCREEN_WIDTH / 2, SCREEN_Y_POSITION + __SCREEN_HEIGHT - 2 * 8, END_LAYER}, NULL}, 
