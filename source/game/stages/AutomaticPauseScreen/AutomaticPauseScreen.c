...
PositionedEntityROMDef AUTOMATIC_PAUSE_SCREEN_ST_ENTITIES[] =
{
	{&VBJAENGINE_IM, 	    {__SCREEN_WIDTH >> 1, 40, LAYER_0       }, NULL, NULL, NULL},
	{NULL, {0,0,0}, NULL, NULL, NULL},
};

PositionedEntityROMDef AUTOMATIC_PAUSE_SCREEN_ST_UI_ENTITIES[] =
{
	{NULL, {0,0,0}, NULL, NULL, NULL},
};

TextureROMDef* AUTOMATIC_PAUSE_SCREEN_ST_TEXTURES[] =
{
	NULL
};
...
StageROMDef AUTOMATIC_PAUSE_SCREEN_ST =
{
    // size
    {
        // x
    ...
    //textures to preload
    (TextureDefinition**)AUTOMATIC_PAUSE_SCREEN_ST_TEXTURES,

    //UI
    {
        AUTOMATIC_PAUSE_SCREEN_ST_UI_ENTITIES,
        __TYPE(UI),
    },

    //entities
    AUTOMATIC_PAUSE_SCREEN_ST_ENTITIES,
