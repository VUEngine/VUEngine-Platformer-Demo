...
extern TextureROMDef FLOOR_4_TOP_TX;
...
TextureROMDef FLOOR_4x7_TX =
{
    // charset definition
    (CharSetDefinition*)&FLOOR_4x7_CH,
...
InanimatedInGameEntityROMDef FLOOR_4x7_IG =
{
    {
        {
            __TYPE(InanimatedInGameEntity),
            (SpriteROMDef**)FLOOR_4x7_SPRITES,
        },
