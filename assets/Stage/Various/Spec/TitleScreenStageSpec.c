...
{
	{&LowPowerIndicatorEntitySpec, 	{INGAME_LOW_POWER_ENTITY_X_POSITION, INGAME_LOW_POWER_ENTITY_Y_POSITION, INGAME_LOW_POWER_ENTITY_Z_POSITION, INGAME_LOW_POWER_ENTITY_Z_DISPLACEMENT}, 0, NULL, NULL, NULL, false},
...
extern SoundSpec Soundtrack01;

SoundROMSpec* const TitleScreenStageSounds[] =
{
	&Soundtrack01,
	NULL
};
...
StageROMSpec TitleScreenStage =
{
	...
	// assets
	{
		...
		// background sounds
		(SoundSpec**)TitleScreenStageSounds,
	},
