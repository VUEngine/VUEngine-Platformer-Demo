...
ColliderROMSpec WaterPondColliders[] =
{
	{
		// shape
		__TYPE(Box),
...
PhysicalPropertiesROMSpec WaterPondPhysicalProperties =
{
	// mass
	__F_TO_FIX10_6(0),
	...
	{
		{
			...
			// collision shapes
			(ColliderSpec*)WaterPondColliders,
			...
			(PhysicalProperties*)&WaterPondPhysicalProperties,
		},
