...
ColliderROMSpec MovingPlatformV6Colliders[] =
{
	{
		// shape
		__TYPE(Box),
...
PhysicalPropertiesROMSpec MovingPlatformV6PhysicalProperties =
{
	// mass
	__F_TO_FIX10_6(0),
...
MovingEntityROMSpec MovingPlatformV6Entity =
{
	...
	// collision shapes
				(ColliderSpec*)MovingPlatformV6Colliders,
				...
				(PhysicalProperties*)&MovingPlatformV6PhysicalProperties,
			},
