...
PositionedEntityROMDef LEVEL_DONE_SCREEN_ST_ENTITIES[] =
{
...
PositionedEntityROMDef LEVEL_DONE_SCREEN_ST_UI_ENTITIES[] =
{
...
StageROMDef LEVEL_DONE_SCREEN_ST =
{
	...
	// entities
	{
		// ui
		{
			LEVEL_DONE_SCREEN_ST_UI_ENTITIES,
			__TYPE(UiContainer),
		},

		// children
		LEVEL_DONE_SCREEN_ST_ENTITIES,
	},
};
