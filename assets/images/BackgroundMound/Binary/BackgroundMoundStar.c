...
const unsigned int BackgroundMoundStarTiles[16] __attribute__((aligned(4)))=
{
...
const unsigned short BackgroundMoundStarMap[4] __attribute__((aligned(4)))=
{
